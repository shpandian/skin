...
$(function () {
    ...
    require('@ebay/jquery-next-id/jquery.nextid.min.js');
    require('@ebay/jquery-common-keys/jquery.commonkeys.min.js');
    require('@ebay/jquery-focusable/jquery.focusable.min.js');
    require('@ebay/jquery-focus-exit/jquery.focusexit.min.js');
    require('@ebay/jquery-keyboard-trap/jquery.keyboardtrap.min.js');
    require('@ebay/jquery-screenreader-trap/jquery.screenreadertrap.min.js');
    require('@ebay/jquery-button-flyout/jquery.buttonflyout.min.js');
    require('@ebay/jquery-roving-tabindex/jquery.rovingtabindex.min.js');
    require('@ebay/jquery-prevent-document-scroll-keys/jquery.preventdocumentscrollkeys.min.js');
...
},{"./jquery-shim.js":1,"./jquery.dialog.js":2,"./jquery.dialogbutton.js":3,"./jquery.menu.js":4,"./jquery.tabs.js":5,"@ebay/jquery-button-flyout/jquery.buttonflyout.min.js":7,"@ebay/jquery-common-keys/jquery.commonkeys.min.js":8,"@ebay/jquery-focus-exit/jquery.focusexit.min.js":9,"@ebay/jquery-focusable/jquery.focusable.min.js":10,"@ebay/jquery-keyboard-trap/jquery.keyboardtrap.min.js":11,"@ebay/jquery-next-id/jquery.nextid.min.js":12,"@ebay/jquery-prevent-document-scroll-keys/jquery.preventdocumentscrollkeys.min.js":13,"@ebay/jquery-roving-tabindex/jquery.rovingtabindex.min.js":14,"@ebay/jquery-screenreader-trap/jquery.screenreadertrap.min.js":15,"jquery":16}],7:[function(require,module,exports){
...
(function($,window,document,undefined){var pluginName='jquery-common-keys';var normalizeEvent=function(type,e){return $.Event(type,{originalEvent:e});};$.fn.commonKeys=function commonKeys(){return this.each(function onEach(){if(!$.data(this,pluginName)){jQuery.data(this,pluginName,'true');var $this=$(this),keyCodes=$.fn.commonKeys.keyCodes;var onKeyDown=function(e){switch(e.keyCode){case keyCodes.ENTER:$this.trigger(normalizeEvent('enter.commonKeyDown',e));break;case keyCodes.ESCAPE:$this.trigger(normalizeEvent('escape.commonKeyDown',e));break;case keyCodes.SPACE:$this.trigger(normalizeEvent('space.commonKeyDown',e));break;case keyCodes.PAGEUP:$this.trigger(normalizeEvent('pageup.commonKeyDown',e));break;case keyCodes.PAGEDOWN:$this.trigger(normalizeEvent('pagedown.commonKeyDown',e));break;case keyCodes.END:$this.trigger(normalizeEvent('end.commonKeyDown',e));break;case keyCodes.HOME:$this.trigger(normalizeEvent('home.commonKeyDown',e));break;case keyCodes.LEFTARROW:$this.trigger(normalizeEvent('leftarrow.commonKeyDown',e));break;case keyCodes.UPARROW:$this.trigger(normalizeEvent('uparrow.commonKeyDown',e));break;case keyCodes.RIGHTARROW:$this.trigger(normalizeEvent('rightarrow.commonKeyDown',e));break;case keyCodes.DOWNARROW:$this.trigger(normalizeEvent('downarrow.commonKeyDown',e));break;default:break;}};var onKeyUp=function(e){switch(e.keyCode){case keyCodes.ENTER:$this.trigger(normalizeEvent('enter.commonKeyUp',e));break;case keyCodes.ESCAPE:$this.trigger(normalizeEvent('escape.commonKeyUp',e));break;case keyCodes.SPACE:$this.trigger(normalizeEvent('space.commonKeyUp',e));break;case keyCodes.PAGEUP:$this.trigger(normalizeEvent('pageup.commonKeyUp',e));break;case keyCodes.PAGEDOWN:$this.trigger(normalizeEvent('pagedown.commonKeyUp',e));break;case keyCodes.END:$this.trigger(normalizeEvent('end.commonKeyUp',e));break;case keyCodes.HOME:$this.trigger(normalizeEvent('home.commonKeyUp',e));break;case keyCodes.LEFTARROW:$this.trigger(normalizeEvent('leftarrow.commonKeyUp',e));break;case keyCodes.UPARROW:$this.trigger(normalizeEvent('uparrow.commonKeyUp',e));break;case keyCodes.RIGHTARROW:$this.trigger(normalizeEvent('rightarrow.commonKeyUp',e));break;case keyCodes.DOWNARROW:$this.trigger(normalizeEvent('downarrow.commonKeyUp',e));break;default:break;}};$this.on('keydown',onKeyDown);$this.on('keyup',onKeyUp);}});};$.fn.commonKeys.keyCodes={ENTER:13,ESCAPE:27,SPACE:32,PAGEUP:33,PAGEDOWN:34,END:35,HOME:36,LEFTARROW:37,UPARROW:38,RIGHTARROW:39,DOWNARROW:40};}(jQuery,window,document));
},{}],9:[function(require,module,exports){

(function($,window,document,undefined){$.fn.focusExit=function focusExit(){return this.each(function onEach(){var $this=$(this),relatedTargetShim,timeout;function onElementFocusIn(){window.clearTimeout(timeout);}
function onDocumentFocusIn(e){relatedTargetShim=e.target;}
...
(function($,window,document,undefined){var $trappedEl,$modifiedElements;$.trapScreenreader=function trapScreenReader(el){$.untrapScreenreader();$trappedEl=$(el);var $siblings=$trappedEl.siblings(':not(script, [aria-hidden=true])');var $parents=$trappedEl.parents(':not(html, body)');var $parentsSiblings=$trappedEl.parents(':not(html, body)').siblings(':not(script, [aria-hidden=true])');$trappedEl.attr('aria-hidden','false');$siblings.attr('aria-hidden','true');$parents.attr('aria-hidden','false');$parentsSiblings.attr('aria-hidden','true');$modifiedElements=$trappedEl.add($siblings).add($parents).add($parentsSiblings);$trappedEl.trigger('on.screenreaderTrap');};$.untrapScreenreader=function untrapScreenReader(){if($trappedEl){$modifiedElements.removeAttr('aria-hidden');$trappedEl.trigger('off.screenreaderTrap');}};}(jQuery,window,document));
